...
const Contact = ({ isDark }) => {
  ...
  const socialLinks = [
    ...
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/williams-victor",
      label: "LinkedIn",
    },
    {
      icon: () => (
  ...
  return (
    <section id="contact" className="py-20">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <div className="mb-12">
          <p
            className={`text-sm uppercase tracking-wider ${isDark ? "text-blue-400" : "text-blue-600"} font-medium mb-4`}
          >
            SEND A MESSAGE
          </p>
          <h2
            className={`text-4xl lg:text-5xl font-bold ${isDark ? "text-white" : "text-gray-900"} mb-8`}
          >
            Get In Touch
          </h2>
          <p
            className={`text-lg leading-relaxed ${isDark ? "text-gray-300" : "text-gray-600"} max-w-3xl mx-auto mb-12`}
          >
            I'm currently open to new job opportunities and collaborations. My
            inbox is always open, so whether you have a question, want to work
            together on a project, or just want to say hi, I'll be happy to
            respond.
          </p>
        </div>
        ...
        <button
          onClick={openGmail}
          className={`inline-flex items-center gap-3 px-8 py-4 border-2 ${
            isDark
              ? "border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-gray-900"
              : "border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white"
          } rounded-lg font-medium text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg`}
        ...
        {/* Copyright */}
        <div
          className={`text-center ${isDark ? "text-gray-400" : "text-gray-500"} mb-8`}
        >
          <p>© 2026 - Williams Victor</p>
        </div>
        ...
        <div className="flex justify-center">
          ...
          >
            <div
              className={`p-3 rounded-lg border ${isDark ? "border-gray-600 group-hover:border-gray-500" : "border-gray-300 group-hover:border-gray-400"} transition-colors duration-300`}
            >
