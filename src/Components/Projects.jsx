...
const Projects = ({ isDark }) => {
  const projects = [
    ...
    },
    {
      ...
      title: "MovieNest",
      description:
        "A Netflix-like movie discovery platform where users can browse movies, view trailers, read reviews, and get personalized recommendations.",
      image: movienestImg,
  ...
  const ProjectCard = ({ project }) => (
    <div
      ...
      } rounded-2xl overflow-hidden shadow-xl transition-transform hover:scale-105 duration-300`}
    >
